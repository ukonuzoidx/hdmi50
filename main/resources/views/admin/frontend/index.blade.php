                                            ...
                                            @if ($k != 'images')
                                                ...
                                                @elseif($item == 'textarea')
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label
                                                                class="form-control-label  font-weight-bold">{{ inputTitle($k) }}</label>
                                                            <textarea rows="10" class="form-control" placeholder="{{ inputTitle($k) }}" name="{{ $k }}"
                                                ...
                                                @elseif($item == 'textarea-nic')
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label
                                                                class="form-control-label  font-weight-bold">{{ inputTitle($k) }}</label>
                                                            <textarea rows="10" class="form-control nicEdit" placeholder="{{ inputTitle($k) }}"
                                                ...
                                                @elseif($k == 'select')
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label
                                                                class="form-control-label  font-weight-bold">{{ inputTitle(@$selectName) }}</label>
        ...
        @if (@$section->element)
                                                ...
                                                @foreach ($section->element as $k => $type)
                                                    @if ($k != 'modal')
                                                        ...
                                                        @elseif($k == 'select')
                                                            ...
                                                            @endphp
                                                            <td
                                                                data-label="{{ __(inputTitle(@$section->element->$k->name)) }}">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"> @lang('Add New') {{ __(inputTitle($key)) }} @lang('Item')
                            </h5>
            ...
            <div id="updateBtn" class="modal fade" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"> @lang('Update') {{ __(inputTitle($key)) }} @lang('Item')
                            </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
            ...
            @push('breadcrumb-plugins')
                @if ($section->element->modal)
                    <a href="javascript:void(0)" class="btn btn-sm btn--primary box--shadow1 text--small addBtn"><i
                            class="fa fa-fw fa-plus"></i>@lang('Add New')</a>
                @else
                    <a href="{{ route('admin.frontend.sections.element', $key) }}"
                        class="btn btn-sm btn--success box--shadow1 text--small"><i
                            class="fa fa-fw fa-plus"></i>@lang('Add New')</a>
                @endif
            @endpush
        @endif
