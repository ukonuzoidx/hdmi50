...
@section('content')
    <div class="container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            ...
            <a href="javascript:void(0)" class="btn btn-sm btn--primary mb-4 text--small addBtn"><i
                    ...
                    <form action="{{ route('admin.frontend.manage.pages.save') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" placeholder="@lang('Page Name')"
                                    name="name" value="{{ old('name') }}" required>
                            </div>
                            <div class="form-group">
                                <label> @lang('Slug') </label>
                                <input type="text" class="form-control form-control-lg" name="slug"
                                    placeholder="@lang('Slug')" value="{{ old('slug') }}" required>
                            </div>
                        </div>
