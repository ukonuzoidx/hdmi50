...
@section('content')
    <div class="container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            ...
            <a href="{{ route('admin.frontend.manage.pages') }}" class="btn btn-sm btn--primary mb-4 text--small"><i
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                placeholder="@lang('Page Name')" name="name" value="{{ $pdata->name }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                placeholder="@lang('Page Slug')" name="slug" value="{{ $pdata->slug }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                @if ($pdata->secs != null)
                                    @foreach (json_decode($pdata->secs) as $sec)
                                        <li class="highlight icon-move item">
                                            ...
                                            <span class="d-inline-block text-white mr-auto ml-2">
                            ...
                            @foreach ($sections as $k => $secs)
                                @if (!@$secs['no_selection'])
                                    <li class="highlight icon-move clearfix">
                                        ...
                                        <span class="d-inline-block text-white mr-auto ml-2 mt-2">
                                            {{ __($secs['name']) }}</span>
                                        <i class="ml-auto d-inline-block remove-icon fa fa-times"></i>
                                        ...
                                        @if ($secs['builder'])
                                            <div class="float-right d-inline-block manage-content">
                                                <a href="{{ route('admin.frontend.sections', $k) }}" target="_blank"
                                                    ...
                                                    data-toggle="tooltip" data-original-title="@lang('Manage Content')">
