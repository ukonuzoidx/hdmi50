                            ...
                            <div class="row">
                                            ...
                                            <div class="thumb">
                                                <div class="avatar-preview">
                                                    <div class="profilePicPreview"
                                                        style="background-image: url({{ getImage(imagePath()['seo']['path'] . '/' . @$seo->data_values->image, imagePath()['seo']['size']) }})">
                                                ...
                                                <div class="avatar-edit">
                                                    ...
                                                    <small class="mt-2 text-facebook">@lang('Supported files'):
                                                        ...
                                                        {{ imagePath()['seo']['size'] }}@lang('px'). </small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-8 mt-xl-0 mt-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" rows="3" class="form-control" placeholder="@lang('SEO meta description')"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="social_description" rows="3" class="form-control" placeholder="@lang('Social Share  meta description')"
