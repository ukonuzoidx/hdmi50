    ...
    <div class="container-fluid">
        ...
        <div class="row mt-50 mb-none-30">
            <div class="col-xl-12 mb-30">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">@lang('Monthly Withdraw for both SHIB and Earnings Report')</h5>
            ...
            <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                <div class="dashboard-w1 bg--success b-radius--10 box-shadow">
                    ...
                    <div class="details">
                        <div class="numbers">
                            <span
                                class="amount">{{ getAmount($paymentWithdraw['total_withdraw_amount']) }}</span>
            ...
            <div class="col-xl-6 col-lg-6 col-sm-6 mb-30">
                <div class="dashboard-w1 bg--success b-radius--10 box-shadow">
                    ...
                    <div class="details">
                        <div class="numbers">
                            <span
                                class="amount">{{ getAmount($paymentWithdrawShiba['total_withdraw_shiba_amount']) }}</span>
                            <span class="currency-sign">SHIB</span>
                        </div>
                        <div class="desciption">
                            <span>@lang('Total Withdraw Shiba')</span>
                        </div>
                        {{-- <a href="{{route('admin.withdraw.approved')}}"
                       class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a> --}}
                    </div>
            ...
            <div class="col-xl-6 col-lg-6 col-sm-6 mb-30">
                <div class="dashboard-w1 bg--warning b-radius--10 box-shadow">
                    ...
                    <div class="details">
                        <div class="numbers">
                            <span
                                class="amount">{{ $paymentWithdrawShiba['total_withdraw_shiba_pending'] }}</span>
                        </div>
                        <div class="desciption">
                            <span>@lang('Withdraw Shiba Pending')</span>
                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        var options = {
            series: [{
                name: 'Total Withdraw Shiba',
                data: [
                    @foreach ($report['months'] as $month)
                        {{ getAmount(@$withdrawalShibaMonth->where('months', $month)->first()->withdrawShibaAmount) }},
                    @endforeach
                ]
            }, {
                name: 'Total Withdraw',
