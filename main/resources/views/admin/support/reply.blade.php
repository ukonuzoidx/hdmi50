...
@section('content')
    <div class="container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            ...
            <a href="{{ route('admin.ticket') }}" class="btn btn-sm btn--primary mb-4">
                    ...
                    <div class="card-body ">
                        ...
                        @if ($ticket->status != 3)
                            <form action="{{ route('admin.ticket.reply', $ticket->id) }}" enctype="multipart/form-data"
                                ...
                                <button type="button" class="btn btn--dark add-more mt-2"><i
                            ...
                            @if ($message->admin_id == 0)
                                <div class="row border border-primary border-radius-3 my-3 mx-2">
                                    <div class="col-md-3 border-right text-right">
                                        ...
                                        @endif
                                        <button data-id="{{ $message->id }}" type="button" data-toggle="modal"
                                            data-target="#DelMessage" class="btn btn-danger btn-sm my-3 delete-message"><i
