                            ...
                            <div class="payment-method-header d-flex flex-wrap">
                                <div class="thumb">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview"
                                            style="background-image: url({{ getImage(imagePath()['withdraw']['method']['path'] . '/' . $method->image, imagePath()['withdraw']['method']['size']) }})">
                                        </div>
                                    </div>
                                ...
                                <div class="content">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="font-weight-bold">@lang('Currency') <span
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="font-weight-bold">@lang('Rate') <span
                                                        class="text-danger">*</span></label>

                                                <div class="input-group has_append">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">1 USD
                                                            =
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="font-weight-bold">@lang('Processing Time') <span
                                                        class="text-danger">*</span></label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card border--primary mb-2">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <label class="font-weight-bold">@lang('Minimum Amount') <span
                                                        class="text-danger">*</span></label>
                                                ...
                                                <label class="font-weight-bold">@lang('Maximum Amount') <span
                                                        class="text-danger">*</span></label>
                                                <div class="input-group has_append">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card border--primary">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <label class="font-weight-bold">@lang('Fixed Charge') <span
                                                        class="text-danger">*</span></label>
                                                <div class="input-group has_append mb-3">
                                                    <input type="text" class="form-control" placeholder="0"
                                                        name="fixed_charge"
