                        ...
                        <ul class="contact-info">
                            ...
                            <li>
                                ...
                                <div class="cont">
                                    ...
                                    <span class="info"><a
                                            href="Mailto:{{ @$contact->data_values->email_address }}">{{ @$contact->data_values->email_address }}</a></span>
                                </div>
                            </li>
                            {{-- <li>
                            <div class="icon">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name') }}"
                                        class="form-control form--control" placeholder="@lang('Your Name')" id="name"
                                        required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" value="{{ old('email') }}" id="email"
                                        placeholder="@lang('Enter E-Mail Address')" required class="form-control form--control">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="subject" class="form--label text--title">@lang('Subject')</label>
                                    <input type="text" name="subject" placeholder="@lang('Write your subject')"
